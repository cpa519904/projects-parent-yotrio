...
public class HttpTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        HttpPost httpPost = new HttpPost("http://localhost:8008/api/poundLog/save");
        // 设置请求的header
        httpPost.addHeader("Content-Type", "application/json;charset=utf-8");
        // 设置请求的参数
        JSONObject jsonParam = new JSONObject();
        jsonParam.put("token", "中文呢");
...
//        String token = "中文是否乱码";
//        map.put("token", token);
//        String response = HttpUtil.post("http://localhost:8008/api/poundLog/save", map);
//        // 打印执行结果
